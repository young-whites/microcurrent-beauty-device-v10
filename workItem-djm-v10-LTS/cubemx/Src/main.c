...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SYSTEM_POWER_CTRL_Pin|START_LED_CTRL_Pin|BEEP_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SYSTEM_POWER_CTRL_Pin START_LED_CTRL_Pin BEEP_Pin */
  GPIO_InitStruct.Pin = SYSTEM_POWER_CTRL_Pin|START_LED_CTRL_Pin|BEEP_Pin;
