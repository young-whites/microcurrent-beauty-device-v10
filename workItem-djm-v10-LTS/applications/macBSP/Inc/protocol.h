 ...
 * ===========================================================================*/
#define WAVEFORM_POWER_SMOOTH       1   /* 30~1000μA, 50Hz, 300us, symm. square */
#define WAVEFORM_BURST_TRAIN        2   /* 30~1000μA, 50Hz burst 10Hz, 300us */
#define WAVEFORM_GENTLE_SMOOTH      3   /* 0~1000μA, 35Hz, 300us, symm. square */
#define WAVEFORM_DEEP_SCULPT        4   /* 30~1000μA, 40~50Hz, 4kHz balanced sq */
#define WAVEFORM_SOFT_SCULPT        5   /* 30~1000μA, 30~40Hz, 2~4kHz sine */
#define WAVEFORM_CIRCUL_SCULPT      6   /* 0~1000μA, 2~10Hz, 4kHz bal. sine */
#define WAVEFORM_SMOOTH_FIRM        7   /* 0~1000μA, 80~100Hz, 400us, tri */
#define WAVEFORM_LYMPH_DRAIN        8   /* 0~1000μA, 5Hz, 450us, low-freq sine */
#define WAVEFORM_SOOTHING_END       9   /* 0~1000μA, 500Hz, sine */
