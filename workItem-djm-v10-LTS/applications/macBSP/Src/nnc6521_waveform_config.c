...
const uint32_t g_current_level_map_bc[WAVEFORM_COUNT][WAVEFORM_LEVEL_COUNT] = {
    /* Waveform 1 */
    { 0, 400, 500, 600, 1200, 1500, 1750, 2000, 2250, 2500, 18000 },
    /* Waveform 2 */
    { 0, 400, 500, 600, 650, 750, 850, 1000, 1100, 1250, 16000 },
    /* Waveform 3 */
    { 0, 400, 500, 600, 650, 750, 850, 1000, 1100, 1250, 14000 },
    /* Waveform 4 */
    { 0, 2000, 4000, 6000, 8000, 10000, 12000, 14000, 16000, 18000, 20000 },
    /* Waveform 5 */
    { 0, 250, 500, 750, 1000, 1250, 1500, 1750, 2000, 2250, 2500 },
    /* Waveform 6 */
    { 0, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 16000 },
    /* Waveform 7 */
    { 0, 600, 1200, 1800, 2400, 3000, 3600, 4200, 4800, 5400, 10000 },
    /* Waveform 8 */
