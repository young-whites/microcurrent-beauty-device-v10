...
const uint32_t g_current_level_map_a[WAVEFORM_COUNT][WAVEFORM_LEVEL_COUNT] = {
    ...
    { 0, 2000,4000, 8000, 15000, 32000, 40000, 48000, 56000, 72000, 80000 },
    /* Waveform 2 — max 16000 */
    { 0, 2000,4000, 8000, 15000, 32000, 40000, 48000, 56000, 72000, 80000 },
    /* Waveform 3 — max 14000 */
    { 0, 3000,6000,4000, 15000, 30000, 36000, 42000, 48000, 54000, 60000 },
    /* Waveform 4 — max 20000 */
    { 0, 2000,4000, 8000, 15000, 32000, 40000, 48000, 56000, 72000, 80000 },
    /* Waveform 5 — max 2500 */
    { 0, 2000,4000, 8000, 15000, 32000, 40000, 48000, 56000, 72000, 80000 },
    /* Waveform 6 — max 16000 */
    { 0, 3000,6000,9000, 15000, 30000, 36000, 42000, 48000, 54000, 60000 },
    /* Waveform 7 — max 10000 */
    { 0, 2500, 5000, 10000, 20000, 25000, 30000, 35000, 40000, 45000, 50000 },
    /* Waveform 8 — max 7500 */
    { 0, 2000, 4000, 8000, 16000, 20000, 24000, 28000, 32000, 36000, 40000 },
    /* Waveform 9 — max 12500 */
    { 0, 1500, 3000, 6000, 12000, 15000, 18000, 21000, 24000, 27000, 30000 }
};
