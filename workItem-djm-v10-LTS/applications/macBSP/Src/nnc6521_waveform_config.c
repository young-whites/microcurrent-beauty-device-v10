...
const uint32_t g_current_level_map_a[WAVEFORM_COUNT][WAVEFORM_LEVEL_COUNT] = {
    /* Waveform 1 — max 18000 */
    { 0, 4000,8000, 16000, 24000, 32000, 40000, 48000, 56000, 72000, 80000 },
    /* Waveform 2 — max 16000 */
    { 0, 4000,8000, 16000, 24000, 32000, 40000, 48000, 56000, 72000, 80000 },
    /* Waveform 3 — max 14000 */
