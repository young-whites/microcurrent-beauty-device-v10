...
const waveform_config_t g_waveform_configs[WAVEFORM_COUNT] =
{
    /* ---- Waveform 1: Power Smooth ---- */
    {
        ...
        .min_current     = 30,       /* Minimum output current 30 mA */
    ...
    /* ---- Waveform 3: Gentle Smooth ---- */
    {
        ...
        .min_current     = 20,       /* Lower minimum current */
        .max_current     = 60,       /* Lower maximum current */
